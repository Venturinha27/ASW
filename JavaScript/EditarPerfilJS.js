...
function showEditarPerfilVoluntario() {
    ...
    if (epevol != null) {
        ...
        xmlhttp.open("POST", "../Controller/EditarPerfilController.php?show_editar_perfil_voluntario=yes", true);
        xmlhttp.send();
    }
}
...
function showEditarPreferenciasVoluntario() {
    ...
    if (eprvol != null) {
        ...
        xmlhttp.open("POST", "../Controller/EditarPerfilController.php?show_editar_preferencias_voluntario=yes", true);
        xmlhttp.send();
    }
}
...
function addArea(){
    ...
    if (selecta.value != "") {
        ...
        xmlhttp.open("POST", "../Controller/EditarPerfilController.php?add_area_interesse="+String(selecta.value), true);
        xmlhttp.send();
    }
}
...
function addPopulacao(){
    ...
    if (selectp.value != "") {
        ...
        xmlhttp.open("POST", "../Controller/EditarPerfilController.php?add_populacao_alvo="+String(selectp.value), true);
        xmlhttp.send();
    }
}
...
function addDisponibilidade(){
    ...
    if (selectd.value != "" && selecth.value != "" && selectdu.value != "") {
        ...
        xmlhttp.open("POST", "../Controller/EditarPerfilController.php?add_dia="+String(selectd.value)+"&add_hora="+String(selecth.value)+"&add_duracao="+String(selectdu.value), true);
        xmlhttp.send();
    }
}
...
function removeArea(area){
    ...
    xmlhttp.open("POST", "../Controller/EditarPerfilController.php?remove_area_interesse="+String(area), true);
    xmlhttp.send();
}
...
function removePopulacao(populacao){
    ...
    xmlhttp.open("POST", "../Controller/EditarPerfilController.php?remove_populacao_alvo="+String(populacao), true);
    xmlhttp.send();
}
...
function removeDisponibilidade(dia, hora, duracao){
    ...
    xmlhttp.open("POST", "../Controller/EditarPerfilController.php?remove_dia="+String(dia)+"&remove_hora="+String(hora)+"&remove_duracao="+String(duracao), true);
    xmlhttp.send();
}
...
function showEditarPerfilInstituicao() {
    ...
    if (epeins != null) {
        ...
        xmlhttp.open("POST", "../Controller/EditarPerfilController.php?show_editar_perfil_instituicao=yes", true);
        xmlhttp.send();
    }
}
...
function showEditarPreferenciasInstituicao() {
    ...
    if (eprins != null) {
        ...
        xmlhttp.open("POST", "../Controller/EditarPerfilController.php?show_editar_preferencias_instituicao=yes", true);
        xmlhttp.send();
    }
}
...
function DCF2 () {
    var distrito = document.getElementById("distrito2"),
    concelho = document.getElementById("concelho2"),
    freguesia = document.getElementById("freguesia2");

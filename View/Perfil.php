                ...
                <div id='Msg'>";
                    ...
                    /* echo "<div class='w3-container w3-border-top w3-border-bottom w3-hover' id='conversaopen'>
                            <header class='w3-white w3-text-indigo'>
                                    <button class='w3-button'><i class='fas fa-arrow-left'></i></button> <p><b>Tiago</b></p>
                            </header>
                            ...
                            <div class='textes'>
                                <div class='msgt'>
                                    <div class='msgown'>
                                        ...
                                        <div class='msgtext'>
                                            <p class='msgtextp'>Olá Tiago!</p>
                                            <p class='msgtexth'>23:45</p>
                                        </div>
                                    </div> 
                                </div>
                                <div class='msgt'>
                                    <div class='msgother'>
                                        <img src='../Images/voluntario.jpg' alt='Avatar' class='w3-left w3-circle'>
                                        <div class='msgtext'>
                                            <p class='msgtextp'>Olá Manuel, o meu nome é joaoa mandebhd vhjebfhvbehj vbnjebnfjvbenj vkjenvjkenjvn!</p>
                                            <p class='msgtexth'>23:45</p>
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <div class='msgt'>
                                    <div class='msgown'>
                                        <img src='../Images/voluntario.jpg' alt='Avatar' class='w3-left w3-circle'>
                                        <div class='msgtext'>
                                            <p class='msgtextp'>Epa realmente tens razão chavalo</p>
                                            <p class='msgtexth'>23:45</p>
                                        </div>
                                    </div> 
                                </div>
                            ...
                            <footer>
                                <input type='text' placeholder='Escreva uma mensagem...'></input>
                                <button class='w3-button w3-hover-none'>
                                    <i class='fas fa-paper-plane'></i>
                                </button>
                            </footer>
                    </div>"; */
                    /* <div class='w3-indigo w3-border-top w3-border-white'>
                    ...
                    <div class='conversa w3-container w3-border-top w3-border-bottom w3-hover'>
                        <img src='../Images/voluntario.jpg' alt='Avatar' class='w3-left w3-circle'>
                        <h6 class='nomeS w3-small'><b>Tiago</b></h6>
                        <p class='sugestaoTxt w3-tiny'>Tiago: Olá Manuel.</p>
                        <p class='msgHora w3-tiny'>23:45</p>
                    </div>
                    <div class='conversa w3-container w3-border-top w3-border-bottom w3-hover'>
                        <img src='../Images/voluntario.jpg' alt='Avatar' class='w3-left w3-circle'>
                        <h6 class='nomeS w3-small'><b>Tiago</b></h6>
                        <p class='sugestaoTxt w3-tiny'>Tiago: Olá Manuel.</p>
                        <p class='msgHora w3-tiny'>Há 3 dias</p>
                    </div> */
                echo "</div>
